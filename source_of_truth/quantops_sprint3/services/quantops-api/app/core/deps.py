...
def get_dashboard_service() -> DashboardService:
    return DashboardService(get_v12_client(), get_scheduler_repository())
...
def get_scheduler_service() -> SchedulerService:
    return SchedulerService(get_scheduler_repository(), get_audit_repository())
...
def get_control_service() -> ControlService:
    return ControlService(get_v12_client(), get_audit_repository(), get_analytics_repository())
...
def get_alert_service() -> AlertService:
    return AlertService(get_alert_repository(), get_audit_repository(), get_risk_repository())
