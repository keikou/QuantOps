...
PLAN_DOC = REPO_ROOT / "docs" / "Alpha_factory_governance_operator_control_packet03_plan.md"
TASK_DOC = REPO_ROOT / "docs" / "04_tasks" / "afg03_rbac_permission_model_2026-04-25.md"
...
def main() -> None:
    ...
    needles = [
        ...
        "/system/authorization/latest",
        "/system/authorization/denials/latest",
        "/system/roles/latest",
        "/system/permissions/latest",
        "/system/roles/assign",
        "/system/roles/revoke",
        "/system/actor-permissions/{actor_id}",
        "/system/authorization/audit/latest",
    ]
